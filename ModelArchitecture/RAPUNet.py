...
def create_model(img_height, img_width, input_chanels, out_classes, starting_filters):
    ...
    s5 = add([l5i, p5]) 
    t51 = resnet_block(resnet_block (s5, starting_filters * 32), starting_filters * 32)
    t53 = resnet_block(resnet_block (t51, starting_filters * 16), starting_filters*32) #11,11
